...
/* this function is intended for use by applications to store permenant
...
/* this function should be called just before all persistent
   information is supposed to be written to clean out the existing persistent
   cache. */
void
