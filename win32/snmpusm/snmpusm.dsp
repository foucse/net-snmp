...
# ADD LINK32 libsnmp.lib wsock32.lib msvcrt.lib kernel32.lib user32.lib oldnames.lib /nologo /subsystem:console /machine:I386 /nodefaultlib /out:"../bin/snmpusm.exe" /libpath:"..\lib"
...
# ADD LINK32 snmp_d.lib wsock32.lib libcmt.lib kernel32.lib user32.lib oldnames.lib advapi32.lib /nologo /subsystem:console /debug /machine:I386 /nodefaultlib /out:"../bin/snmpusm_d.exe" /pdbtype:sept /libpath:"../lib"
